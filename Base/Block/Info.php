...
use Awd\Base\Block\Adminhtml\System\Config\SysInfo\DownloadButton;
    ...
    private function getCronInfo($fieldset)
    {
        ...
        if ($crontabCollection->count() === 0) {
            ...
            if (!$this->moduleInfoProvider->isOriginMarketplace()) {
                $value .=
                    '<a target="_blank"
                  href="https://support.advancedwebsitedesign.co.uk/index.php?/Knowledgebase/Article/View/72/24/magento-cron">' .
                    __('Learn more') .
                    '</a>';
            }
        } else {
