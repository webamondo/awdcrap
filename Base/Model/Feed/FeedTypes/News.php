...
namespace Awd\Base\Model\Feed\FeedTypes;
...
class News
{
     ...
     * @return string[]
     */
    private function getInstalledAwdExtensions(): array
    {
        if (!$this->awdModules) {
            $modules = $this->moduleList->getNames();
     ...
     * @return bool
     */
    private function validateByAwdCount($counts): bool
    {
        $result = true;
    ...
    /**
     * @param string[] $awdModules
     *
     * @return array
     */
    private function getDependModules(array $awdModules): array
    {
        $depend = [];
        $result = [];
        $dataName = [];
