...
class Extensions
{
    ...
    const AWD_EXTENSIONS_LAST_MODIFIED_DATE = 'awd_extensions_last_modified_date';
    ...
    {
        return $this->cache->load(self::AWD_EXTENSIONS_LAST_MODIFIED_DATE);
    }
    ...
    private function setLastModified()
    {
        ...
        return $this->cache->save($dateTime, self::AWD_EXTENSIONS_LAST_MODIFIED_DATE);
    }
