...
use Awd\Base\Model\Serializer;
use Magento\Framework\Config\CacheInterface;

class Ads
{
    const CSV_CACHE_ID = 'awd_base_csv';
    const AWD_ADS_LAST_MODIFIED_DATE = 'awd_ads_last_modified_date';
    ...
    {
        return $this->cache->load(self::AWD_ADS_LAST_MODIFIED_DATE);
    }
    ...
    private function setLastModified()
    {
        ...
        return $this->cache->save($dateTime, self::AWD_ADS_LAST_MODIFIED_DATE);
    }
