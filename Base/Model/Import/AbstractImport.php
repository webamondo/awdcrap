...
use Awd\Base\Model\Import\Behavior\BehaviorProviderInterface;
use Awd\Base\Model\Import\Mapping\MappingInterface;
use Awd\Base\Model\Import\Validation\EncodingValidator;
...
abstract class AbstractImport extends AbstractEntity
{
    ...
    protected function processValidation(array $rowData)
    {
        ...
        foreach ($this->validatorPool->getValidators() as $validator) {
            ...
            } catch (\Awd\Base\Exceptions\StopValidation $exception) {
