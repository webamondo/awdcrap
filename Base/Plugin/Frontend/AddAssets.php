...
namespace Awd\Base\Plugin\Frontend;

use Awd\Base\Model\LessToCss\Config\Converter;
...
class AddAssets
{
    const CACHE_KEY = 'awd_should_load_css_files';
    ...
    /**
     * @var \Awd\Base\Model\LessToCss\Config
     */
    private $lessConfig;
    ...
    public function __construct(
        ...
        \Awd\Base\Model\LessToCss\Config $lessConfig,
    ...
    {
        // i.e. 'Awd_Checkout::css/styles.css'
