...
/**
 * For Remote Debug
 * Output is going to file awd_debug.log
 * @codeCoverageIgnore
...
class Log
{
     ...
     * @var string
     */
    private static $fileToLog = 'awd_debug.log';
...
%message%
----------------------------------------------------------------------------\n\n";
        $formatter = new System\AwdFormatter($output);

        $handler->setFormatter($formatter);
        self::$loggerInstance = new \Magento\Framework\Logger\Monolog('awd_logger', [$handler]);
    }
}
