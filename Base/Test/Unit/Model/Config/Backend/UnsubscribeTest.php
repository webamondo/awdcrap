...
namespace Awd\Base\Test\Unit\Model\Config\Backend;

use Awd\Base\Model\Config\Backend\Unsubscribe;
...
class UnsubscribeTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testPrepareMessage()
    {
        ...
        $messageManager = $this->createMock(\Awd\Base\Model\AdminNotification\Messages::class);
    ...
    public function generateMessageDataProvider()
    {
        return [
            ...
            [
                ...
                '<img src="https://advancedwebsitedesign.co.uk/frontend/base/default/images/awd/notifeed/unsubscribe_all.svg"/>'
                . '<span>You have successfully unsubscribed from All Notifications.</span>'
            ],
            [
                NotificationType::GENERAL,
                '<img src="https://advancedwebsitedesign.co.uk/frontend/base/default/images/awd/notifeed/info.svg"/>'
