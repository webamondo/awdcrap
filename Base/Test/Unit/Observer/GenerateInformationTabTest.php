...
namespace Awd\Base\Test\Unit\Observer;

use Awd\Base\Model\Feed\ExtensionsProvider;
use Awd\Base\Model\ModuleInfoProvider;
use Awd\Base\Observer\GenerateInformationTab;
...
class GenerateInformationTabTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->assertEquals(
            '<div class="awd-additional-content"><span class="message success">test</span></div>',
